...
Queue:64          ; 16 bytes to hold last 16 entries
RunningSum:6     ; sum of last 8 entries
Round:6          ; divide by 8 and round.
temp
    endc
...
;$$$$$$-----$$$$$
; The sweetest MainLoop you've EVER seen in your life!!!!!!
; Here's a secret easter egg, if you have actually READ this code, you will see this.
; Leave the word WOOT4MSD in the comments if you've read this. 	
...
Filter:
     ...
     incf      FSR,f
     movf      FSR,w
     xorlw     Queue+64        ; did it overflow?
...
;MAStraightline  ; 53 instructions, 55 cycles including call and & return
	 ...
	 bcf       STATUS,C       ; clear the carry
     rrf       Round+1,f
     rrf       Round,f        ; divide by 16
     
	 bcf       STATUS,C       ; clear the carry
     rrf       Round+1,f
     rrf       Round,f        ; divide by 32

	 bcf       STATUS,C       ; clear the carry
     rrf       Round+1,f
     rrf       Round,f        ; divide by 64
